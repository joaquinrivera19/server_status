...
$services[] = array("port" => "80",       "service" => "Web server",                  "ip" => "172.30.0.136") ;
$services[] = array("port" => "21",       "service" => "FTP",                     "ip" => "172.30.0.136") ;
$services[] = array("port" => "3306",     "service" => "MYSQL",                   "ip" => "172.30.0.136") ;
// $services[] = array("port" => "3000",     "service" => "Mastodon web",                   "ip" => "") ;
// $services[] = array("port" => "4000",     "service" => "Mastodon streaming",                   "ip" => "") ;
$services[] = array("port" => "22",       "service" => "Open SSH",				"ip" => "172.30.0.136") ;
$services[] = array("port" => "58846",     "service" => "Deluge",             	"ip" => "172.30.0.136") ;
$services[] = array("port" => "8112",     "service" => "Deluge Web",             	"ip" => "172.30.0.136") ;
$services[] = array("port" => "80",       "service" => "Internet Connection",     "ip" => "172.30.0.136") ;
$services[] = array("port" => "8083",     "service" => "Vesta panel",             	"ip" => "172.30.0.136") ;
